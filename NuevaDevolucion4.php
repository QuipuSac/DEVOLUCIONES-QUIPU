	...
	<div>
		...
		<div class="panel bordepanel">
			<div class="panel-heading" STYLE="background-color:#6E6E6E">
				<font color="FFFFFF">
					<h3 class="panel-title">Registro de Cantidades Recibidas-Pedido: <?php echo $_POST['xpedido']; ?> </h3>
				</font>
			</div>
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="input-group">
							...
							<input id="CODIGO" type="text" class="form-control" onClick="this.select()" onblur="JalarItem($('#CODIGO').val()),JalarItemid($('#CODIGO').val()),
					...
					<div class="col-sm-2">
						...
						<div class="input-group">
							...
							<input id="CANTIDADITEM" type="number" class="form-control" onClick="this.select()" onblur="JalarItemPrecio($('#idITEM').val(),$('#CANTIDADITEM').val(),$('#idunidaditem').val())">
						</div>
					</div>
					<div class="col-sm-3">
						<div class="input-group">
					...
					<div class="col-sm-2">
						<div class="input-group">
							<button type="button" class="buttonpedido" id="agregarproducto" onclick="agregaritem($('#idITEM').val(),$('#PRECIOITEM').val(),$('#CANTIDADITEM').val(),$('#idunidaditem').val()),
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="pull-right">
								...
								<input name="documento2" id="documento1" type="radio" value="1" onClick="SeleccionaDocumento(1)" <?php if ((int) $idTipoDocuReferencia == 1) {
																																		echo "checked";
																																	} ?> />
								<font color="585858"><label id="valorticket">Factura</label></font>
								<input name="documento2" id="documento3" type="radio" value="3" onClick="SeleccionaDocumento(3)" <?php if ((int) $idTipoDocuReferencia == 3) {
																																		echo "checked";
																																	} ?> />
							...
							<div class="pull-right">
								<select class="form-control" data-width="auto" id="fpago">
									...
									while ($rowfpago = sqlsrv_fetch_array($recfpago)) {
										...
										?>
										<option value="<?php echo $clave; ?>" <?php if ((int) $formapago == (int) $clave) {
																						echo "selected";
